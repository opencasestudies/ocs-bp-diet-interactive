---
title: |
  ![](https://opencasestudies.github.io/img/icon-bahi.png){width=140px align=left}   
...
```{r, echo=FALSE}
diet_data <- readr::read_csv("www/docs/dietary_risk_exposure_all_ages_2017.csv")
sep_age_diet_data <- read_csv("www/docs/dietary_risk_exposure_sep_ages_2017.csv")
```
...
```{r, echo=FALSE}
paper <- pdftools::pdf_text("www/docs/Afshin et al. 2019 - Health effects of dietary risks in 195 countries,  ... 17 - a systematic analysis for the Global Burden of Disease Study 2017.pdf")
```
...
load("www/data/wrangled_data.rda")
```
...
```{r, fig.height = 17, fig.width = 14, eval=FALSE}
...
```{r, fig.height = 26, fig.width = 18, eval=FALSE}
...
```{r, fig.width = 16, fig.height = 18, eval=FALSE}
...
```{r, fig.height=33, fig.width = 34, eval=FALSE}
